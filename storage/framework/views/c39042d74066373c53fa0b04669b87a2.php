...
<body class="bg-coksu">
    <nav class="navbar-materi-menu">
        <div class="nav-left">
            <a href="<?php echo e(route('admin.materi.index')); ?>" class="nav-menu-link">
    ...
    <!-- Bootstrap 5 JS (popper juga jika belum ada) -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    <script>
    // Fix bfcache/restore state
...
<?php /**PATH C:\xampp\htdocs\si-ukur\resources\views/layouts/master.blade.php ENDPATH**/ ?>