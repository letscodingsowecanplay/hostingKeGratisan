...
<div class="login-page-wrap">
    <div class="login-card-color">
        ...
        <form method="POST" action="<?php echo e(route('login.siswa')); ?>" class="login-form-multicolor">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\si-ukur\resources\views/auth/loginSiswa.blade.php ENDPATH**/ ?>