...
<div class="materi-main-container">
    ...
    <div class="materi-section fs-5">
        <p class="mb-1">
            ...
            <audio id="audio-index-1" src="<?php echo e(asset('sounds/materi/hal8/1.mp3')); ?>"></audio>
        </p>
    </div>

    <div class="materi-section">
        <div class="text-center my-4">
            <img src="<?php echo e(asset('images/materi/susunan-sasi.png')); ?>"
    ...
    <div class="materi-section" style="margin-bottom: 0;">
        <div class="kearifan-box" style="background: #fffde7; border-left: 5px solid #ffb300; padding: 16px 18px; border-radius: 10px; font-size: 1.06em; color: #775b08; margin-bottom: 18px; box-shadow: 0 2px 8px #ffb30018;">
            ...
            <audio id="audio-narasi-1" src="<?php echo e(asset('sounds/materi/hal8/narasi-1.mp3')); ?>"></audio>
        </div>
    </div>
    ...
    <div class="materi-section fs-5">
        ...
        <audio id="audio-index-2" src="<?php echo e(asset('sounds/materi/hal8/2.mp3')); ?>"></audio>
    ...
    <div class="materi-nav-footer" style="margin-top:32px;">
        <a href="<?php echo e(route('admin.materi.halaman7')); ?>" class="btn-nav" style="min-width:160px;">
            ← Sebelumnya
        </a>
        <a href="<?php echo e(route('admin.materi.halaman9')); ?>" class="btn-nav btn-next" style="min-width:160px;">
            Selanjutnya →
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\si-ukur\resources\views/admin/materi/halaman8.blade.php ENDPATH**/ ?>