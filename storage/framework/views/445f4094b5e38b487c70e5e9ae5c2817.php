...
<div class="materi-main-container fs-5" id="halaman16-container">
    ...
    <div class="materi-section shadow-sm rounded-3 py-3 px-3" style="background:#fff;">
        <div class="materi-content mb-3">
            ...
            <audio id="audio-index-1" src="<?php echo e(asset('sounds/materi/hal16/1.mp3')); ?>"></audio>
            <br>
            ...
            <div class="d-flex justify-content-center gap-2 mb-2" id="stepper-soal">
                <?php for($no = 1; $no <= $jumlahSoal; $no++): ?>
                    <button type="button"
                        ...
                        onclick="renderSoal(<?php echo e($no); ?>)"
        ...
        <div id="reviewArea" class="mt-4" style="<?php echo e(count($jawabanUser ?? []) === $jumlahSoal ? '' : 'display:none;'); ?>"></div>
...
<link rel="stylesheet" href="<?php echo e(asset('css/dragdrop.css')); ?>">
<script>
const soalList = <?php echo json_encode($soalList, 15, 512) ?>;
const penjelasan = <?php echo json_encode($penjelasan, 15, 512) ?>;
const audioPenjelasan = <?php echo json_encode($audioPenjelasan, 15, 512) ?>;
const audioFeedback = <?php echo json_encode($audioFeedback, 15, 512) ?>;
const jumlahSoal = <?php echo e($jumlahSoal); ?>;
const kunci = {1:5,2:5,3:4,4:7,5:7};
let jawabanUser = <?php echo json_encode($jawabanUser ?? [], 15, 512) ?>;
let skorRes = <?php echo e($skor ?? 0); ?>;
...
function renderSoal(no) {
    ...
    if (sudahDiisi) {
        ...
        dropzoneIsi = [...Array(jwb)].map(() =>
            `<img src="<?php echo e(asset('images/materi/ayo-berlatih-3/')); ?>/${satuan}.png" class="alat-satuan shadow ${alatSatuanClass}" draggable="false" style="border:2px solid ${border};">`
        ).join('');
    ...
    <div class="mb-5 soal-ayo-berlatih" id="blokSoal${no}">
        <div class="d-flex align-items-center gap-2 mb-2">
            ...
            <div class="materi-content fw-bold" style="font-size:1.09rem; margin-bottom:0;">
                ...
                <audio id="audio-hal16-${no}" src="<?php echo e(asset('sounds/materi/hal16/hal16-')); ?>${no}.mp3"></audio>
            </div>
        </div>
        <div>
            <div class="gambar-wrapper">
                <img src="<?php echo e(asset('images/materi/ayo-berlatih-3/')); ?>/${gambar}" class="gambar-soal">
            ...
            <div class="satuan-area" id="satuan-area-${no}">
                ${[...Array(10)].map((_,i)=>`
                    <div class="satuan-slot" data-slot="${i+1}">
                        <img src="<?php echo e(asset('images/materi/ayo-berlatih-3/')); ?>/${satuan}.png"
...
function periksaSoal(no){
    ...
    let img = benar ? "<?php echo e(asset('images/materi/ayo-berlatih-3/benar.png')); ?>" : "<?php echo e(asset('images/materi/ayo-berlatih-3/salah.png')); ?>";
    ...
    fetch("<?php echo e(route('admin.materi.halaman16.simpan')); ?>", {
        method: 'POST',
        body: data,
    })
    .then(res => res.json())
...
function showPenjelasanSetelahPeriksa(no) {
    ...
    if (jawaban > 0 && zone) {
        alatHtml = [...Array(jawaban)].map(() =>
            `<img src="<?php echo e(asset('images/materi/ayo-berlatih-3/')); ?>/${soal.satuan}.png" class="alat-satuan shadow mb-1 ${alatSatuanClass}" draggable="false" style="border:2px solid ${border};">`
        ).join('');
        ...
        <div class="panel-review-soal" id="panelReviewSoal${i}" style="display:${selected==i?'':'none'};">
            <div class="mb-3 text-center">
                <div class="gambar-wrapper" style="position:relative;">
                    <img src="<?php echo e(asset('images/materi/ayo-berlatih-3/')); ?>/${soal.gambar}" class="gambar-soal">
                    <div class="drop-zone ${soal.orientasi} ${soal.dropzone||''}" style="pointer-events:none; border:2.4px solid ${border} !important;">
                        ${[...Array(jawaban>0?jawaban:0)].map(()=>
                            `<img src="<?php echo e(asset('images/materi/ayo-berlatih-3/')); ?>/${satuan}.png" class="alat-satuan shadow mb-1 ${alatSatuanClass}" draggable="false" style="border:2px solid ${border};">`
                        ).join('')}
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\si-ukur\resources\views/admin/materi/halaman16.blade.php ENDPATH**/ ?>