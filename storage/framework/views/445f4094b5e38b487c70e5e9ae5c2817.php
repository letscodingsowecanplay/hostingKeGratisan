...
<div class="materi-main-container fs-5" id="halaman16-container">
    ...
    <div class="materi-section shadow-sm rounded-3 py-3 px-3" style="background:#fff;">
        ...
        <div id="stepper-soal-container" class="mb-4" <?php if($sudahMenjawab): ?> style="display:none;" <?php endif; ?>>
        ...
        <form id="kuisForm" autocomplete="off" <?php if($sudahMenjawab): ?> style="display:none;" <?php endif; ?>>
            <?php echo csrf_field(); ?>
        ...
        <div id="reviewArea" class="mt-4" <?php if(!$sudahMenjawab): ?> style="display:none;" <?php endif; ?>></div>
        <form action="<?php echo e(route('admin.materi.halaman16.reset')); ?>" method="POST" class="mt-3" id="formResetKuis" style="display:none;">
            <?php echo csrf_field(); ?>
...
let sudahMenjawab = <?php echo e($sudahMenjawab ? 'true' : 'false'); ?>;
...
function periksaSoal(no){
    ...
    let img = benar ? "<?php echo e(asset('images/feedback/benar.png')); ?>" : "<?php echo e(asset('images/feedback/salah.png')); ?>";
                ...
                <div class="gambar-wrapper" style="position:relative;">
                    ...
                    <div class="drop-zone ${soal.orientasi} ${soal.custom_class||''}" style="pointer-events:none;">
                        ${[...Array(jawaban>0?jawaban:0)].map(()=>
                            `<img src="<?php echo e(asset('images/materi/ayo-berlatih-3/')); ?>/${satuan}.png" class="alat-satuan shadow mb-1" style="border:2px solid ${benar?'#4caf50':'#e53935'};" draggable="false">`
                        ).join('')}
                    </div>
                </div>
            </div>
