...
<div class="materi-main-container">
    ...
    <div class="materi-section" style="margin-bottom: 0;">
        <div class="kearifan-box" style="background: #fffde7; border-left: 5px solid #ffb300; padding: 15px 18px; border-radius: 10px; font-size: 1.08em; color: #775b08; margin-bottom: 18px; box-shadow: 0 2px 8px #ffb30018;">
            <strong style="font-size:1.1em;">Tahukah Kalian?</strong><br>
            ...
            <audio id="audio-narasi-1" src="<?php echo e(asset('sounds/materi/hal3/narasi-1.mp3')); ?>"></audio>
        </div>
    </div>
    ...
    <div class="materi-section">
        <div class="materi-image-row">
            <div class="materi-image-col">
                <img src="<?php echo e(asset('images/materi/jukung-big.png')); ?>" class="img-fluid rounded shadow" alt="Jukung Panjang">
                <div class="materi-caption">
                    ...
                    <audio id="audio-index-1" src="<?php echo e(asset('sounds/materi/hal3/1.mp3')); ?>"></audio>
                </div>
            </div>
            <div class="materi-image-col">
                <img src="<?php echo e(asset('images/materi/jukung-mini.png')); ?>" class="img-fluid rounded shadow" alt="Jukung Pendek">
                <div class="materi-caption">
                    ...
                    <audio id="audio-index-2" src="<?php echo e(asset('sounds/materi/hal3/2.mp3')); ?>"></audio>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="materi-section" style="margin-bottom: 0;">
        <div class="kearifan-box" style="background: #e3f2fd; border-left: 5px solid #1976d2; padding: 15px 18px; border-radius: 10px; font-size: 1.08em; color: #175093; margin-bottom: 18px; box-shadow: 0 2px 8px #1976d218;">
            <strong style="font-size:1.1em;">Tahukah Kalian?</strong><br>
            ...
            <audio id="audio-narasi-2" src="<?php echo e(asset('sounds/materi/hal3/narasi-2.mp3')); ?>"></audio>
        </div>
    </div>
    ...
    <div class="materi-section">
        <div class="materi-image-row">
            <div class="materi-image-col">
                <img src="<?php echo e(asset('images/materi/rumahadat-big.png')); ?>" class="img-fluid rounded shadow" alt="Rumah Adat Banjar Tinggi">
                <div class="materi-caption">
                    ...
                    <audio id="audio-index-3" src="<?php echo e(asset('sounds/materi/hal3/3.mp3')); ?>"></audio>
                </div>
            </div>
            <div class="materi-image-col">
                <img src="<?php echo e(asset('images/materi/rumahadat-mini.png')); ?>" class="img-fluid rounded shadow" alt="Rumah Adat Mini">
                <div class="materi-caption">
                    ...
                    <audio id="audio-index-4" src="<?php echo e(asset('sounds/materi/hal3/4.mp3')); ?>"></audio>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="materi-section" style="margin-bottom: 0;">
        <div class="kearifan-box" style="background: #fff3e0; border-left: 5px solid #ff9800; padding: 15px 18px; border-radius: 10px; font-size: 1.08em; color: #a95d05; margin-bottom: 18px; box-shadow: 0 2px 8px #ff980018;">
            <strong style="font-size:1.1em;">Tahukah Kalian?</strong><br>
            ...
            <audio id="audio-narasi-3" src="<?php echo e(asset('sounds/materi/hal3/narasi-3.mp3')); ?>"></audio>
        </div>
    </div>
    ...
    <div class="materi-section">
        <div class="materi-image-row">
            <div class="materi-image-col">
                <img src="<?php echo e(asset('images/materi/bekantan-big.png')); ?>" class="img-fluid rounded shadow" alt="Patung Bekantan Tinggi">
                <div class="materi-caption">
                    ...
                    <audio id="audio-index-5" src="<?php echo e(asset('sounds/materi/hal3/5.mp3')); ?>"></audio>
                </div>
            </div>
            <div class="materi-image-col">
                <img src="<?php echo e(asset('images/materi/bekantan-mini.png')); ?>" class="img-fluid rounded shadow" alt="Miniatur Bekantan">
                <div class="materi-caption">
                    ...
                    <audio id="audio-index-6" src="<?php echo e(asset('sounds/materi/hal3/6.mp3')); ?>"></audio>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="materi-section">
        <div class="materi-content">
            ...
            <audio id="audio-index-7" src="<?php echo e(asset('sounds/materi/hal3/7.mp3')); ?>"></audio>
        </div>
        <div class="materi-content" style="margin-top:16px;">
            ...
            <audio id="audio-index-8" src="<?php echo e(asset('sounds/materi/hal3/8.mp3')); ?>"></audio>
        </div>
    </div>

    <!-- Navigasi bawah -->
    <div class="materi-nav-footer">
        <a href="<?php echo e(route('admin.materi.halaman2')); ?>" class="btn-nav">
            ← Sebelumnya
        </a>
        <a href="<?php echo e(route('admin.materi.halaman4')); ?>" class="btn-nav btn-next">
            Selanjutnya →
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\si-ukur\resources\views/admin/materi/halaman3.blade.php ENDPATH**/ ?>