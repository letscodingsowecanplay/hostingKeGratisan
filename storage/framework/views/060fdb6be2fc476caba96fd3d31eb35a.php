...
<div class="materi-main-container fs-5">
    <div class="materi-section shadow-sm rounded-3 py-3 px-3" style="background:#fff;">
        ...
        <div class="materi-content">
            ...
            <audio id="audio-index-1" src="<?php echo e(asset('sounds/materi/hal14/1.mp3')); ?>"></audio>
            <br><br>
    ...
    <div class="materi-section shadow-sm rounded-3 py-3 px-3" style="background:#fff;">
        <div class="materi-image-row justify-content-center my-1">
            <div class="materi-image-col" style="max-width:330px">
                <img src="<?php echo e(asset('images/materi/perbedaan-hasil-ukur.png')); ?>" 
        ...
        <div class="materi-caption text-center mt-2" style="font-size:1.08rem;">
            ...
            <audio id="audio-index-2" src="<?php echo e(asset('sounds/materi/hal14/2.mp3')); ?>"></audio>
        </div>
    </div>
    ...
    <div class="materi-section" style="margin-bottom: 0;">
        <div class="kearifan-box" style="background: #e3f2fd; border-left: 5px solid #1976d2; padding: 16px 18px; border-radius: 10px; font-size: 1.06em; color: #175093; margin-bottom: 18px; box-shadow: 0 2px 8px #1976d218;">
            ...
            <audio id="audio-narasi-1" src="<?php echo e(asset('sounds/materi/hal14/narasi-1.mp3')); ?>"></audio>
        </div>
    </div>

    <div class="materi-nav-footer mt-3">
        <a href="<?php echo e(route('admin.materi.halaman13')); ?>" class="btn btn-nav fs-5">← Sebelumnya</a>
        <a href="<?php echo e(route('admin.materi.halaman15')); ?>" class="btn btn-nav btn-next fs-5">Selanjutnya →</a>
    </div>
</div>
<br>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\si-ukur\resources\views/admin/materi/halaman14.blade.php ENDPATH**/ ?>