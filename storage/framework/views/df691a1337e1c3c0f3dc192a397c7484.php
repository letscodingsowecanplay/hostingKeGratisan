    ...
    <div class="dashboard-bar" id="subbab-materi-bar">
        ...
        <div class="card-box red-card" id="menu-subbab-1">
            <div class="card-content-wrap">
                ...
                <audio id="audio-index-0" src="<?php echo e(asset('sounds/materi/index/1.mp3')); ?>"></audio>
                </div>
                <div class="card-content text-light">Membandingkan dan Mengurutkan Panjang Benda</div>
                <a href="<?php echo e(route('admin.materi.halaman2')); ?>" class="card-btn">Buka Materi</a>
            </div>
        </div>
        ...
        <div class="card-box green-card position-relative" id="menu-subbab-2">
            <div class="card-content-wrap">
                ...
                <audio id="audio-index-1" src="<?php echo e(asset('sounds/materi/index/3.mp3')); ?>"></audio>
                </div>
                <div class="card-content text-light">Mengukur Panjang Benda
                </div>
                <a id="link-subbab-2" href="<?php echo e(route('admin.materi.halaman11')); ?>" class="card-btn">Buka Materi</a>
                <!-- Overlay Gembok -->
...
window.initKunciSidebar = function(statusLulus) {
    ...
    menus.forEach(item => {
        ...
        if (!statusLulus[item.prasyarat] || statusLulus[item.prasyarat] !== 'lulus') {
            ...
            if (linkEl) {
                linkEl.setAttribute('href', "<?php echo e(route('admin.materi.halaman11')); ?>");
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\si-ukur\resources\views/admin/materi/index.blade.php ENDPATH**/ ?>