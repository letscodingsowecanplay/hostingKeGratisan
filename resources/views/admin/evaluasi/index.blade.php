    ...
    <div class="navigasi-section shadow materi-card2">
        ...
        <div class="mt-2 text-center" style="width:100%;">
            <div class="kuis-btn-grid mb-2">
                ...
                <a href="{{ route('admin.materi.index') }}" class="btn btn-danger btn-nav fs-5" style="grid-column:span 2; font-family: 'Montserrat', Arial, sans-serif;">Kembali ke Materi</a>
            </div>
        </div>
    </div>
</div>
