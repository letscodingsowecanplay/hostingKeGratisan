...
<div class="materi-main-container fs-5">
    ...
    <div class="materi-section" style="margin-bottom: 0;">
        <div class="kearifan-box" style="background: #fffde7; border-left: 5px solid #ffb300; padding: 16px 18px; border-radius: 10px; font-size: 1.08rem; color: #775b08; margin-bottom: 18px; box-shadow: 0 2px 8px #ffb30018;">
            ...
            <audio id="audio-narasi-1" src="{{ asset('sounds/materi/hal13/narasi-1.mp3') }}"></audio>
        </div>
    </div>

    <div class="materi-nav-footer mt-3">
        <a href="{{ route('admin.materi.halaman12') }}" class="btn btn-nav fs-5">← Sebelumnya</a>
        <a href="{{ route('admin.materi.halaman14') }}" class="btn btn-nav btn-next fs-5">Selanjutnya →</a>
    </div>
</div>
<br>
@endsection
