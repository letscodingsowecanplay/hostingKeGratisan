...
<div class="materi-main-container" id="halaman4-container">
    ...
    <div class="materi-section mb-5 fs-5">
        ...
        <div class="position-relative mx-auto mb-3 contoh-gambar-h4" style="max-width: 600px; height: 300px;">
            <img src="{{ asset('images/materi/ayo-mencoba-1/contoh-lat-1.png') }}" class="w-100 h-100 rounded shadow contoh-gambar-bg" style="object-fit: cover;">
            <div class="position-absolute contoh-gambar-kiri" style="top: 65%; left: 25%; transform: translate(-50%, -50%);">
                <img src="{{ asset('images/materi/ayo-mencoba-1/contoh-lat-2.png') }}" width="180" height="180" class="shadow contoh-gambar-pilihan">
            ...
            <div class="position-absolute contoh-gambar-kanan" style="top: 65%; left: 75%; transform: translate(-50%, -50%);">
                <img src="{{ asset('images/materi/ayo-mencoba-1/contoh-lat-3.png') }}" width="180" height="180" class="shadow contoh-gambar-pilihan">
    ...
    <div id="stepper-soal">
        ...
        <div class="materi-section mb-5 fs-5 soal-step" id="soal-step-{{ $no }}" style="@if($no !== $firstUnanswered)display:none;@endif">
            ...
            <div id="penjelasan-{{ $no }}" class="mt-2 mb-3">
                @if(isset($jawabanUser['soal'.$no]))
                    ...
                    <div class="card card-body border-info bg-light d-flex flex-column align-items-center gap-3">
                        <span>{!! $penjelasanText[$no][$explainType] !!}
                        <button onclick="toggleAudio(this)" type="button" class="btn-audio mt-2"
                        data-id="penjelasan-{{ $explainType . $no }}" data-playing="false">🔊</button>
                        <audio id="audio-penjelasan-{{ $explainType . $no }}" src="{{ $audioPenjelasanSrc }}"></audio></span>
                    </div>
                @endif
            </div>
        </div>
...
function showFeedbackPopup(feedback, soalNo, isBenar, afterClose) {
    ...
    let audioPath = isBenar
        ? '{{ asset('sounds/materi/hal4/benar') }}' + soalNo + '.mp3'
        : '{{ asset('sounds/materi/hal4/salah') }}' + soalNo + '.mp3';
