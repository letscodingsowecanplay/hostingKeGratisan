...
<div class="materi-main-container">
    ...
    <div class="materi-section">
        <div class="materi-content">
            <p class=" mb-1">
                ...
                <audio id="audio-index-2" src="{{ asset('sounds/materi/hal7/2.mp3') }}"></audio>
            </p>
        </div>
    </div>
    ...
    <div class="materi-section">
        <div class="materi-content">
            ...
            <audio id="audio-index-3" src="{{ asset('sounds/materi/hal7/3.mp3') }}"></audio>
            <p class="mt-2 ">
    ...
    <div class="materi-nav-footer" style="margin-top:32px;">
        <a href="{{ route('admin.materi.halaman6') }}" class="btn-nav" style="min-width:160px;">
            ← Sebelumnya
        </a>
        <a href="{{ route('admin.materi.halaman8') }}" class="btn-nav btn-next" style="min-width:160px;">
            Selanjutnya →
        </a>
    </div>
</div>
