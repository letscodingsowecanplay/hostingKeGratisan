...
<div class="materi-main-container fs-5" id="halaman15-container">
    ...
    {{-- STEPPER SOAL --}}
    <div id="stepper-soal" class="mb-4" @if(isset($sudahMenjawab) && $sudahMenjawab) style="display:none;" @endif>
            ...
            @for ($no = 1; $no <= $totalSoal; $no++)
                ...
                <div class="materi-section shadow-sm rounded-3 py-3 px-3 review-step" id="review-step-{{ $no }}" style="@if($no>1)display:none;@endif;background:#fff;">
                    ...
                    <div class="text-center mb-2">
                        @if($userJawab)
                            <span class="badge warna-label {{ $isCorrect ? 'green-card' : 'red-card' }}">
                                Jawaban Kamu: {{ ucfirst($userJawab) }}
                            </span>
                            <span class="badge warna-label {{ ($kunciJawab == $userJawab) ? 'green-card' : 'red-card' }} ms-2">
