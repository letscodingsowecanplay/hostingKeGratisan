                ...
                <div class="offcanvas-md offcanvas-start" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    <div class="offcanvas-body sidebar-sticky d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column pt-2">
                            ...
                            <li class="nav-item mb-1">
                                <a id="menu-subbab-1"
                                   class="nav-link {{ $isSubbab1 ? 'active' : '' }}" data-accent="green" href="{{ route('admin.materi.index') }}">
                            ...
                            <li class="nav-item mb-1">
                                <a id="menu-subbab-2"
                                   class="nav-link {{ $isSubbab2 ? 'active' : '' }}" data-accent="blue" href="{{ route('admin.materi.halaman11') }}">
                                    <span data-feather="folder" class="feather"></span>
                            ...
                            @can('evaluasi_access')
                            <li class="nav-item mb-1">
                                <a id="menu-ayo-evaluasi" class="nav-link {{ (request()->is('admin/evaluasi*')) ? 'active' : '' }}" data-accent="orange" href="{{ route('admin.evaluasi.petunjuk') }}">
